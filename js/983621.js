...
document.getElementById("prim-nav-5").innerHTML = "<a href='tjhcomp.co.uk/cybersecurity.html'>Security</a>";
document.getElementById("mob-nav-1").innerHTML = "<a href='tjhcomp.co.uk/index.html' class='current'>Home</a>";
document.getElementById("mob-nav-2").innerHTML = "<a href='tjhcomp.co.uk/computing.html'>Computing</a>";
document.getElementById("mob-nav-3").innerHTML = "<a href='tjhcomp.co.uk/networking.html'>Networking</a>";
document.getElementById("mob-nav-4").innerHTML = "<a href='tjhcomp.co.uk/programming.html'>Programming</a>";
document.getElementById("mob-nav-5").innerHTML = "<a href='tjhcomp.co.uk/security.html'>Security</a>";
document.getElementById("foot-nav-1").innerHTML = "<a href='tjhcomp.co.uk/computing.html'>Computing</a>";
document.getElementById("foot-nav-2").innerHTML = "<a href='tjhcomp.co.uk/networking.html'>Networking</a>";
document.getElementById("foot-nav-3").innerHTML = "<a href='tjhcomp.co.uk/programming.html'>Programming</a>";
document.getElementById("foot-nav-4").innerHTML = "<a href='tjhcomp.co.uk/cybersecurity.html'>Security</a>";
//document.getElementById("foot-nav-5").innerHTML = "<a href='tjhcomp.co.uk/privacy.html'>Privacy</a>";
//document.getElementById("foot-nav-6").innerHTML = "<a href='tjhcomp.co.uk/guidelines.html'>Guidelines</a>";
