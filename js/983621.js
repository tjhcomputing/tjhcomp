...
document.getElementById("prim-nav-1").innerHTML = "<a href='#' class='current'>Home</a>";
document.getElementById("prim-nav-2").innerHTML = "<a href='#'>Computing</a>";
document.getElementById("prim-nav-3").innerHTML = "<a href='#'>Networking</a>";
document.getElementById("prim-nav-4").innerHTML = "<a href='#'>Programming</a>";
document.getElementById("prim-nav-5").innerHTML = "<a href='#'>Security</a>";
document.getElementById("mob-nav-1").innerHTML = "<a href='#' class='current'>Home</a>";
document.getElementById("mob-nav-2").innerHTML = "<a href='#'>Computing</a>";
document.getElementById("mob-nav-3").innerHTML = "<a href='#'>Networking</a>";
document.getElementById("mob-nav-4").innerHTML = "<a href='#'>Programming</a>";
document.getElementById("mob-nav-5").innerHTML = "<a href='#'>Security</a>";
document.getElementById("foot-nav-1").innerHTML = "<a href='#'>Computing</a>";
document.getElementById("foot-nav-2").innerHTML = "<a href='#'>Networking</a>";
document.getElementById("foot-nav-3").innerHTML = "<a href='#'>Programming</a>";
document.getElementById("foot-nav-4").innerHTML = "<a href='#'>Security</a>";
document.getElementById("foot-nav-5").innerHTML = "<a href='#'>Privacy</a>";
document.getElementById("foot-nav-6").innerHTML = "<a href='#'>Guidelines</a>";
document.getElementById("foot-nav-7").innerHTML = "<a href='#'>About</a>";
